---
{"dg-publish":true,"permalink":"/crash-course/3-hr-mern-stack-traversy-media/2-11-dynamic-auth-header/","noteIcon":""}
---

### Header
- code the Header component to change when there is an auth state in the state manager
